...
function onlyEvenValues(arr){
    //creating an empty array to store the even values 
    let result =[]; 

// use for loop to loop through the input array 
...
const people = [
  ...
  const updatedPeople = addKeyAndValue(people, 'title', 'instructor');
...
const arr = [
  ...
  const result = extractKey(arr, 'name');
  
  console.log(result); // ['Elie', 'Tim', 'Matt', 'Colt']
...
const names = [
  ...
  const fullNames = extractFullName(names);
